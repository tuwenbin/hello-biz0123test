        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form id="form-horizontal" class="form-horizontal" role="form" action="<%=basePath%>addStudent.action" enctype="multipart/form-data" method="post">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 学号 </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" placeholder="Student ID" class="col-xs-10 col-sm-5" name="id"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-2" placeholder="Username" class="col-xs-10 col-sm-5" name="name" />
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-8 col-sm-11">
                                            <div class="input-group">
                                                <input class="form-control date-picker" id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd" style="size: 100px;width: 100px;" name="birthday"/>
