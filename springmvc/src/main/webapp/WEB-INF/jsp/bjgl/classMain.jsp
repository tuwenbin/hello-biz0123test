            ...
            <div class="page-header">
                <h1>
                    ...
                    <small style="margin-left: 1000px;">
                        <a href="<%=basePath%>toClassAddForm.action" target="body">新增</a>
                    </small>
                </h1>
            </div><!-- /.page-header -->
            <div class="row">
                <div class="col-xs-12">
                    <table id="simple-table" class="table  table-bordered table-hover">
                        ...
                        <tbody>
                        <c:forEach items="${classListVO}" varStatus="c" var="classc">
                            <tr>
                                <td>
                                        ${c.index+1}
                                </td>
                                <td>${classc.cname}</td>
                                <td >${classc.stu_sum}</td>
                                <td >${classc.class_mark_avg}</td>
                                <td><a href="<%=basePath%>toClassUpdateForm.action?cid=${classc.cid}">修改</a></td>
                                <td><a href="<%=basePath%>deleteClass.action?cid=${classc.cid}">删除</a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
